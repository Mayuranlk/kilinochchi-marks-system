...
import { flattenSchemaColumns } from "../../utils/reportSchemas";
import {
          ...
          >
            <thead>
              <tr>
                ...
                <th style={thStyle} rowSpan={2}>Student ID</th>
                <th style={thStyle} rowSpan={2}>Index No</th>
                <th style={thStyle} rowSpan={2}>Students Name</th>

                {schema.groups.map((group) => (
                  <th key={group.key} style={thStyle} colSpan={group.columns.length}>
                    {group.label || ""}
                  </th>
                ))}

                <th style={thStyle} rowSpan={2}>Total</th>
                <th style={thStyle} rowSpan={2}>Average</th>
                <th style={thStyle} rowSpan={2}>Rank</th>
              </tr>
              <tr>
            ...
            <tbody>
              {rows.map((row) => (
                <tr key={row.student.id}>
                  ...
                  <td style={tdStyle}>{row.studentIndexNo}</td>
                  ...
                  <td style={tdStyle}>{formatNumber(row.total)}</td>
                  <td style={tdStyle}>{formatNumber(row.average)}</td>
